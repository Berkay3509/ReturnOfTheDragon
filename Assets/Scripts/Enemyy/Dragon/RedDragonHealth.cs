...
public class RedDragonHealth : MonoBehaviour
{
    ...
    public static event Action<RedDragonHealth> OnRedDragonDied;
    ...
    public void TakeDamage(float _damage)
    {
        ...
        if (currentHealth > 0)
        {
            // anim.SetTrigger("StunedTrigger"); // Bu satýrý yorum satýrý yap veya sil
            if (hurtSound != null)
