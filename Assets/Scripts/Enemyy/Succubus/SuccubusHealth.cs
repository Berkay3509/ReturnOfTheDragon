...
using System.Collections.Generic; // List için deðil ama Behaviour dizisi için kalabilir
using System; // Action (event) için eklendi

public class SuccubusHealth : MonoBehaviour
{
    [Header("Health")]
    ...
    public static event Action<SuccubusHealth> OnSuccubusDied;
